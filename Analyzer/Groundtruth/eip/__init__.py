...
_cip_payloads = [
    ...
    [EIPPayload.request(1), EIPPayload.request(2), EIPPayload.request(1), EIPPayload.request(10), EIPPayload.request(14), EIPPayload.request(1), EIPPayload.request(30)],
    [EIPPayload.request(2), EIPPayload.request(14)],
    ...
    [EIPPayload.request_path(1, 28)],
    [EIPPayload.request(2), EIPPayload.request(14)],
    [EIPPayload.request(2), EIPPayload.request(2), EIPPayload.request(14)],
    [EIPPayload.request(2)],
    [EIPPayload.request(1), EIPPayload.request(2), EIPPayload.request(1), EIPPayload.request(10), EIPPayload.request(14), EIPPayload.request(1), EIPPayload.request(30)],
    [EIPPayload.request(25)],
    [EIPPayload.request(10)],
