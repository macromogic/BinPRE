...
python3 $SCRIPTS_PATH/mock_client.py $PROTO -d - | python3 -u blackboard.py --detector $DETECTOR > $PROTO.log 2> >(tee $PROTO.err >&2)
awk '/#EVAL_INFO_START/,/#EVAL_INFO_END/' $PROTO.log